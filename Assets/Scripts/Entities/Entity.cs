...
public class Entity : MonoBehaviour, IEntity {
    ...
    public Vector3 GetCenterPosition() {
        return transform.position + controller.Height / 2 * controller.CharacterUp;
    }
    ...
    public Vector3 GetClosestPoint(in Vector3 point) {
        return controller.ClosestPoint(point);
    }

    public Vector3 GetLookDirection() {
        return controller.GetLook();
    }
    ...
    public void ApplyKnockback(in Vector3 impulse) {
